...
use Kanexy\InternationalTransfer\Http\Controllers\TransferBeneficiaryController;
...
Route::group(['middleware' => ['web', 'auth', ColorModeMiddleware::class]], function () {
        Route::group(['prefix' => 'dashboard/international-transfer', 'as' => 'dashboard.international-transfer.'], function () {
                ...
                Route::get("transfer-beneficiaries", TransferBeneficiaryController::class)->name('transfer-beneficiary');
        });
