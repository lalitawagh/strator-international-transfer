    ...
    <div class="p-5">
        <form action="{{ route('dashboard.international-transfer.transfer-reason.update', $money_transfer_reason['id']) }}"
                ...
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mb-2">
                    ...
                    <div class="sm:w-5/6">
                        <input id="reason" name="reason" type="reason"
                            ...
                            value="{{ old('reason', $money_transfer_reason['reason']) }}" required>
                    ...
                    <div class="sm:w-5/6 tillselect-marging">
                        <select name="status" id="status" data-search="true"
                            ...
                            @foreach ($statuses as $status)
                                <option value="{{ $status }}" @if ($money_transfer_reason['status'] == $status) selected @endif>
            ...
            <div class="text-right mt-5">
                ...
                <button id="ReasonUpdate" type="submit" class="btn btn-primary w-24">Update</button>
            </div>
        </form>
    </div>
@endsection
