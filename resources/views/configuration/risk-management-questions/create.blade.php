...
@section('config-content')
    <div class="p-5">
        <form action="{{ route('dashboard.international-transfer.risk-management-questions.store') }}" method="POST"
            ...
            <div class="grid grid-cols-12 md:gap-3 mt-0">
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mb-2">
                    ...
                    <div class="sm:w-5/6">
                        <textarea name="questions" id="questions" rows="3" class="form-control resize-none">{{ old('questions') }}</textarea>
                        @error('questions')
            ...
            <div class="grid grid-cols-12 md:gap-3 mt-0"
                @if (old('answer') == 'yes') x-data="{ selected: '1' }" @elseif (old('answer') == 'no') x-data="{ selected: '0' }" @else x-data="{ selected: '3' }" @endif>
                    ...
                    <div class="sm:w-5/6 sm:pt-3">
                        <div class="form-check mr-2 sm:pt-0">
                            <input id="radio-switch-1" class="form-check-input" type="radio"
                                ...
                                @if (old('answer') == 'yes') checked @endif>
                            ...
                            <input id="radio-switch-2" class="form-check-input ml-3" type="radio"
                                ...
                                @if (old('answer') == 'no') checked @endif>
            ...
            <div class="text-right mt-5">
                ...
                <button id="QuestionsSubmit" type="submit" class="btn btn-primary w-24">Create</button>
            </div>
        </form>
    </div>
@endsection
