...
@section('title', 'Edit Transfer Type Fee')

@section('config-content')
    <div class="p-5">
        <form action="{{ route('dashboard.international-transfer.transfer-type-fee.update',$transfer_type_fee['id']) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-12 md:gap-3 mt-0">
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2 paymentType @if (old('type',$transfer_type_fee['type']) == 'payment_type') active @else hidden @endif " >
                    <label for="payment_type" class="form-label sm:w-30">Payment Type <span class="text-theme-6">*</span></label>
                    <div class="sm:w-5/6">
                        <input type="text" name="payment_type" id="payment_type" class="form-control" value="{{ old('payment_type',@$transfer_type_fee['payment_type']) }}">
                ...
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2 transferType @if (old('type',$transfer_type_fee['type']) == 'transfer_type') active @else hidden @endif" >
                    <label for="transfer_type" class="form-label sm:w-30">Transfer Type <span class="text-theme-6">*</span></label>
                    <div class="sm:w-5/6">
                        <input type="text" name="transfer_type" id="transfer_type" class="form-control"  value="{{ old('transfer_type',@$transfer_type_fee['transfer_type']) }}">
            ...
            <div class="grid grid-cols-12 md:gap-3 mt-0">
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                    ...
                    <div class="sm:w-5/6">
                        <input id="min_amount" name="min_amount" type="text" class="form-control @error('min_amount') border-theme-6 @enderror" value="{{ old('min_amount',$transfer_type_fee['min_amount']) }}" required>
                ...
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                    ...
                    <div class="sm:w-5/6">
                        <input id="max_amount" name="max_amount" type="text" class="form-control @error('max_amount') border-theme-6 @enderror" value="{{ old('max_amount',$transfer_type_fee['max_amount']) }}" required>
            ...
            <div class="grid grid-cols-12 md:gap-3 mt-0">
                ...
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2" style="align-items: inherit;">
                    ...
                    <div class="sm:w-5/6">
                        <textarea name="description" class="form-control">{{ old('description',$transfer_type_fee['description']) }}</textarea>
            ...
            <div class="grid grid-cols-12 md:gap-3 mt-2" @if (old('fee_type',$transfer_type_fee['fee_type']) == 'amount') x-data="{ selected: '1' }" @elseif (old('fee_type',$transfer_type_fee['fee_type']) == 'percentage') x-data="{ selected: '0' }" @else x-data="{ selected: '3' }" @endif>
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                    <label for="amount" class="form-label sm:w-30">Fee <span class="text-theme-6">*</span></label>
                    <div class="sm:w-5/6 sm:pt-0 self-start" >
                        <div class="form-check mr-2 sm:pt-0">
                            <input id="radio-switch-1" class="form-check-input" type="radio" x-on:click="selected = '1'" name="fee_type" value="amount" @if (old('fee_type',$transfer_type_fee['fee_type']) == 'amount') checked @endif>
                            <label class="form-check-label" for="radio-switch-1"><h4 href="javascript:;" class="font-medium truncate mr-5 " >
                                <h4>Amount</h4></label>
                            <input id="radio-switch-2" class="form-check-input ml-3" type="radio"   x-on:click="selected = '0'" name="fee_type" value="percentage" @if (old('fee_type',$transfer_type_fee['fee_type']) == 'percentage') checked @endif>
                ...
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-0" x-show="selected == '0'">
                    ...
                    <div class="sm:w-5/6">
                        <div class="input-group">
                            <input id="percentage" name="percentage" type="text" class="form-control @error('percentage') border-theme-6 @enderror percentage" value="{{ old('percentage',$transfer_type_fee['percentage']) }}">
