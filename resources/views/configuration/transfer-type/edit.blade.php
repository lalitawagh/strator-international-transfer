    ...
    <div class="p-5">
        <form action="{{ route('dashboard.international-transfer.transfer-type-fee.update', $transfer_type_fee['id']) }}"
                    ...
                    <div class="sm:w-5/6">
                        ...
                        <select name="currency" id="currency" data-search="true"
                            ...
                            @foreach ($countries as $country)
                                <option value="{{ $country->id }}" @if (old('currency', $transfer_type_fee['currency']) == $country->id) selected @endif>
                        ...
                        <select name="type" id="type" onchange="getType(this)" data-search="true"
                            ...
                            @foreach ($fee_types as $fee_type)
                                @if ($fee_type == 'payment_type' || $fee_type == 'transfer_type')
                                    <option value="{{ $fee_type }}" @if (old('type', $transfer_type_fee['type']) == $fee_type) selected @endif>
            ...
            <div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-10 mt-0">
                <div
                    ...
                    <div class="sm:w-5/6">
                        <input type="text" name="payment_type" id="payment_type" class="form-control"
                            value="{{ old('payment_type', @$transfer_type_fee['payment_type']) }}">
                ...
                <div
                    class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2 transferType @if (old('type', $transfer_type_fee['type']) == 'transfer_type') active @else hidden @endif">
                    ...
                    <div class="sm:w-5/6">
                        <input type="text" name="transfer_type" id="transfer_type" class="form-control"
                            value="{{ old('transfer_type', @$transfer_type_fee['transfer_type']) }}">
                ...
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                    ...
                    <div class="sm:w-5/6">
                        <input id="min_amount" name="min_amount" type="text"
                            ...
                            value="{{ old('min_amount', $transfer_type_fee['min_amount']) }}" required>
                ...
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                    ...
                    <div class="sm:w-5/6">
                        <input id="max_amount" name="max_amount" type="text"
                            ...
                            value="{{ old('max_amount', $transfer_type_fee['max_amount']) }}" required>
                    ...
                    <div class="sm:w-5/6 tillselect-marging">
                        <select name="status" id="status" data-search="true"
                            ...
                            @foreach ($statuses as $status)
                                <option value="{{ $status }}" @if (old('status', $transfer_type_fee['status']) == $status) selected @endif>
            ...
            <div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-10 mt-0"
                @if (old('fee_type', $transfer_type_fee['fee_type']) == 'amount') x-data="{ selected: '1' }" @elseif (old('fee_type', $transfer_type_fee['fee_type']) == 'percentage') x-data="{ selected: '0' }" @else x-data="{ selected: '3' }" @endif>
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                    ...
                    <div class="sm:w-5/6 sm:pt-3">
                        <div class="form-check mr-2 sm:pt-0">
                            <input id="radio-switch-1" class="form-check-input" type="radio"
                                ...
                                @if (old('fee_type', $transfer_type_fee['fee_type']) == 'amount') checked @endif>
                            ...
                            <input id="radio-switch-2" class="form-check-input ml-3" type="radio"
                                ...
                                @if (old('fee_type', $transfer_type_fee['fee_type']) == 'percentage') checked @endif>
                ...
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2" x-show="selected == '1'">
                    ...
                    <div class="sm:w-5/6">
                        <input id="amount" name="amount" type="text"
                            ...
                            value="{{ old('amount', $transfer_type_fee['amount']) }}">
                    ...
                    <div class="sm:w-5/6">
                        <div class="input-group">
                            <input id="percentage" name="percentage" type="text"
                                ...
                                value="{{ old('percentage', $transfer_type_fee['percentage']) }}">
