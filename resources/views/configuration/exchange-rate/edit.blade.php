                    ...
                    <form action="{{ route('dashboard.international-transfer.exchange-rate.update', $ExchangeRate['id'])}}"
                        ...
                        <div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-10 mt-0">
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                ...
                                <select id="" name="exchange_from" data-search="true"
                                   class="w-full">
                                    @foreach ($countries as $key => $value)
                                        <option value="{{ $key }}" @if ($key == $ExchangeRate->exchange_from) selected @endif>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2">
                                <label for="exchange_to_info" class="form-label sm:w-30">Exchange To <span
                                        class="text-theme-6">*</span></label>
                                <div class="sm:w-5/6 tillselect-marging">
                                    <select id="" name="exchange_to" data-search="true" class="w-full">
                                        @foreach ($countries as $key => $value)
                                            <option value="{{ $key }}" @if ($key == $ExchangeRate->exchange_to) selected @endif>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-span-12 md:col-span-14 xl:col-span-10 form-inline mt-2"
                                ...
                                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                                    ...
                                    <div class="sm:w-5/6 sm:pt-3">
                                        <div class="form-check mr-2">
                                            <input id="radio-switch-1" class="form-check-input" type="radio" x-on:click="selected = '1'"
                                                name="rate_type" value="customize_rate" @if (old('rate_type', $ExchangeRate) == 'customize_rate') checked @endif>
                                    ...
                                    {{-- <div>
                                        <input type="hidden" value="{{$ExchangeRate['id']}}" name="exchangerateinput">
                                    </div> --}}
                                </div>
                                <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2" x-show="selected == '1'">
                                ...
                                <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2" x-show="selected == '0'">
                                    ...
                                    <div class="sm:w-5/6">
                                        <div class="input-group">
                                            <select name="plus_minus" id="percentage_rate" class="form-control"
                                                data-search="true">
                                                <option value=""></option>
                                                <option value="plus" @if (old('plus_minus',$ExchangeRate->plus_minus) == 'plus') selected @endif> + </option>
                                                <option value="minus" @if (old('plus_minus', $ExchangeRate->plus_minus) == 'minus') selected @endif> - </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-span-12 md:col-span-8 xl:col-span-6 form-inline mt-2 ml-1" x-show="selected == '0'">
                        ...
                        <div class="text-right mt-5">
                            <a id="exchangeRateEditCancel" href="{{ route('dashboard.international-transfer.exchange-rate.index') }}"
