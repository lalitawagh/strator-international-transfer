                ...
                <div class="p-5">
                    ...
                    <form action="{{ route('dashboard.international-transfer.exchange-rate.store') }}" method="POST"
                        ...
                        <div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-10 mt-0">
                            ...
                            @else x-data="{ selected: '3' }" @endif>
                                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                                    <label for="rate_type_info" class="form-label sm:w-30">Rate Type <span class="text-theme-6">*</span></label>
                                    <div class="sm:w-5/6 sm:pt-3">
                                        <div class="form-check mr-2">
                                            <input id="radio-switch-1" class="form-check-input" type="radio" x-on:click="selected = '1'"
                                                name="rate_type" value="customize_rate" @if (old('rate_type', @$rate_type) == 'customize_rate') checked @endif>
                                ...
                                <div class="col-span-12 md:col-span-6 xl:col-span-6 form-inline mt-2">
                                    ...
                                    <div class="sm:w-5/6 tillselect-marging">
                                        <select id="exchange_from" name="exchange_from" data-search="true" class="w-full">
                                            ...
                                            <option value="{{ $key }}" @if ($key == old('exchange_from')) selected @endif>
                                                {{ $value }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="sm:w-5/6">
                                        <div class="input-group">
                                            <select name="plus_minus" id="plus_minus" class="form-control"
                                                data-search="true">
                                                <option value=""></option>
                                                <option value="plus" @if (old('plus_minus') == 'plus') selected @endif> + </option>
                                                <option value="minus" @if (old('plus_minus') == 'minus') selected @endif> - </option>
                                            </select>
                                        </div>
                        ...
                        <div class="text-right mt-5">
                            <a id="exchangeRateCreateCancel" href="{{ route('dashboard.international-transfer.exchange-rate.index') }}"
