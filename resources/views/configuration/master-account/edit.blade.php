...
@section("config-content")
    <div class="p-5">
        ...
        @endif
        <form action="{{ route('dashboard.international-transfer.master-account.update',$master_account['id']) }}" method="POST" enctype="multipart/form-data" >
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-12 md:gap-3 mt-0" @if($master_account['country'] != 231) style="display:none" @endif>
                <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2">
                    ...
                    <div class="sm:w-5/6">
                        <input id="beneficiary_id" name="beneficiary_id" type="text" class="form-control @error('beneficiary_id') border-theme-6 @enderror" value="{{ old('beneficiary_id',@$master_account['beneficiary_id']) }}" disabled>
                    </div>
                </div>
            </div>
            ...
            <div class="text-right mt-5">
                <a href="{{ route('dashboard.international-transfer.master-account.index') }}" class="btn btn-secondary w-24 inline-block mr-1">Cancel</a>
