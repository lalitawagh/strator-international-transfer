<div>
    <div class="mb-4 relative">
        <input wire:change="changeAmount($event.target.value)" wire:model="amount" class="input border border-gray-400 appearance-none rounded w-full px-3 py-3 pt-5 pb-2 focus focus:border-indigo-600 focus:outline-none active:outline-none active:border-indigo-600" name="amount" autofocus>
    ...
    <div class="mb-4 relative">
        <input wire:model="recipient_amount" class="input border border-gray-400 appearance-none rounded w-full px-3 py-3 pt-5 pb-2 focus focus:border-indigo-600 focus:outline-none active:outline-none active:border-indigo-600" name="recipient_amount" autofocus>
