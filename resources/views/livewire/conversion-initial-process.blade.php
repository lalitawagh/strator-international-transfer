<div>
    <div class="intro-y col-span-12 sm:col-span-6">
        <h3 class="text-lg font-medium mb-4">Sell</h3>
    ...
    <div class="intro-y col-span-12 sm:col-span-6">
        <h3 class="text-lg font-medium mb-4">Buy</h3>
        <div id="input-group-email" class="input-group-text form-inline cuntery-in flex gap-2">
            <span id="toCountry">
    ...
    <div class="intro-y col-span-6 sm:col-span-6">
        <select id="sellBuy" name="occupation" class="w-full @error('occupation') border-theme-6 @enderror"
        ...
        <div id="input-text">
            <div class="form-inline mb-2">
                <div class="sm:w-3/5">
                    <input id="myslectfiled" name="sell-buy" value="" type="text"
                        class="form-control  @error('sell-buy') border-theme-6 @enderror" style="display: none">
                    @error('sell-buy')
