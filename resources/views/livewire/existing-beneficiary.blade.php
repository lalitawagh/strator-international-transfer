    ...
    <div class="grid rounded-lg w-12/12 md:w-9/12 lg:w-9/12 m-auto p-0 gap-5 mt-5 pt-3">
        ...
        <div class="intro-y col-span-12 lg:col-span-12" style="max-height:400px;overflow-y:auto;">
            @foreach ($beneficiaries as $beneficiary)
                ...
                @endphp
                <div class="relative flex items-center py-2 border-t border-gray-200" wire:click="getBeneficiary({{ $beneficiary->id }})">
                    <div
                    ...
                    <div class="ml-4 mr-auto">
                        ...
                        <div
                            ...
                            <div class="mr-2"> <b>{{ @$receiver->currency}} </b> account ending in {{ substr(@$beneficiary->meta['account_number'],4) }}</div>
