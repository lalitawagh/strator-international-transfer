<div class="grid grid-cols-12 md:gap-0 lg:gap-3 xl:gap-10 mt-0"
    @if (old('cc_rate_type', @$workspaceMeta->value['cc_rate_type']) == 'cc_customize_rate') x-data="{ selected: '1' }" @elseif (old('cc_rate_type', @$workspaceMeta->value['cc_rate_type']) == 'currency_cloud_rate') x-data="{ selected: '0' }" @else x-data="{ selected: '3' }" @endif>
        ...
        <div class="sm:w-5/6 sm:pt-3">
            <div class="form-check mr-2">
                <input id="radio-switch-1" class="form-check-input" type="radio" x-on:click="selected = '1'"
                    name="cc_rate_type" value="cc_customize_rate" @if (old('cc_rate_type', @$workspaceMeta->value['cc_rate_type']) == 'cc_customize_rate') checked @endif>
                ...
                <input id="radio-switch-2" class="form-check-input ml-3" type="radio"
                    ...
                    @if (old('cc_rate_type', @$workspaceMeta->value['cc_rate_type']) == 'currency_cloud_rate') checked @endif>
    ...
    <div class="col-span-12 lg:col-span-12 xl:col-span-6 form-inline mt-2" x-show="selected == '1'">
        ...
        <div class="sm:w-5/6">
            <input id="customized_rate" name="cc_customized_rate" type="text"
                ...
                value="{{ old('cc_customized_rate', @$workspaceMeta->value['cc_customized_rate']) }}">
        ...
        <div class="sm:w-5/6">
            <div class="input-group">
                <select name="cc_percentage_rate" id="percentage_rate" class="form-control"
                    data-search="true">
                    <option value=""></option>
                    <option value="plus" @if (old('cc_percentage_rate',  @$workspaceMeta->value['cc_percentage_rate']) == 'plus') selected @endif> + </option>
                    <option value="minus" @if (old('cc_percentage_rate',  @$workspaceMeta->value['cc_percentage_rate']) == 'minus') selected @endif> - </option>
                </select>
            </div>
        ...
        <div class="sm:w-5/6">
            <div class="input-group">
                <input id="percentage" name="cc_percentage" type="text"
                    ...
                    value="{{ old('cc_percentage', @$workspaceMeta->value['percentage']) }}">
