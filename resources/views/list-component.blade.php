    ...
    <div id="1" class="tab-pane grid grid-cols-12 gap-3 pt-0" role="tabpanel" aria-labelledby="1-tab">
        <div class="active col-span-12 mt-0 w-full" role="tabpanel" id="k-wallet" aria-labelledby="k-wallet-tab">
            ...
            <div class="intro-y mt-0 sm:mt-0">
                ...
                <div
                    class="text-right justify-end flex-wrap sm:flex items-center p-2 sm:py-0 border-b border-gray-200 dark:border-dark-5">
                    <div class="w-auto nav nav-tabs mr-auto hidden sm:flex" role="tablist">
                        <a id="work-in-progress-mobile-new-tab" data-tw-toggle="tab"
                            data-tw-target="#work-in-progress-new" href="javascript:;" class="py-2 ml-0 active"
