            ...
            <div class="intro-y mt-0 p-3">
                <div class="grid rounded-lg w-12/12 md:w-9/12 lg:w-9/12 m-auto p-0">
                    ...
                    <div class="mb-4 relative">
                        <input class="input border border-gray-400 appearance-none rounded w-full px-3 py-3 pt-5 pb-2 focus focus:border-indigo-600 focus:outline-none active:outline-none active:border-indigo-600" type="text" autofocus>
                        ...
                        <div id="input-group-email" class="input-group-text form-inline cuntery-in flex gap-2">
                            <span id="fromCountry">@foreach ($countries as $country)
                                ...
                                @endif
                            @endforeach</span>
                            <select id='tabcuntery-selection1' style='width: 105px;' class="" name="country_code" onchange="getFlagImgFrom(this)">
                    ...
                    <div class="mb-4 relative">
                        <input
                            class="input border border-gray-400 appearance-none rounded w-full px-3 py-3 pt-5 pb-2 focus focus:border-indigo-600 focus:outline-none active:outline-none active:border-indigo-600" type="text" autofocus>
                        ...
                        <div id="input-group-email" class="input-group-text form-inline cuntery-in flex gap-2">
                            <span id="toCountry">@foreach ($countries as $country)
                                ...
                                @endif
                            @endforeach</span>
                            <select id='tabcuntery-selection2' style='width: 105px;' class="" name="country_code" onchange="getFlagImgTo(this)">
                                @foreach ($countries as $country)
                                    <option data-source="{{ $country->flag }}"
                                        value="{{ $country->id }}" @if ($country->id == old('country_code', $defaultCountry->id)) selected @endif>
                                        {{ $country->name }} ({{ $country->phone }})
