...
class MyselfBeneficiary extends Component
{
    ...
    protected function rules()
    {
        return  [
            ...
            'meta.post_code' => ['required_if:country_code,==,' . ShortCode::BBSP . ',' . ShortCode::BAP],
    ...
    protected function messages()
    {
        return  [
            ...
            'meta.benficiary_state.required' => 'The State field is required',
            'meta.ach_routing_number' => 'The ACH Routing Number field is required',
            'meta.branch_code.required' => 'The Branch Code is required',
            'meta.post_code.required' => 'The Post Code is required',
            'meta.bsb_number.required' => 'The BSB Number field is required',
            'meta.aba_number.required' => 'The ABA Number field is required',
            'meta.bic_number.required' => 'The BIC Number field is required',
            'meta.cnaps_number.required' => 'The CNAPS Number field is required',
        ];
    }
