...
class StoreTransferTypeFeeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'max_amount'     =>    ['required','numeric','gt:min_amount','min:0'],
            'fee_type'       =>    ['required'],
    ...
    public function messages()
    {
        return [
            ...
            'max_amount.min'         => 'The max amount should not be a negative value.',
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if(!is_null($currency))
            {
                ...
                {
                    $validator->errors()->add('type', "This country's Type filed has already been selected.");
                }
            }
